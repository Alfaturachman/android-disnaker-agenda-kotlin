...
class DetailPelaporActivity : AppCompatActivity() {
    ...
    private fun fetchDetailMediasi(idMediasi: Int) {
        ...
        RetrofitClient.instance.getDetailPelaporanPelapor(requestBody)
            .enqueue(object : Callback<ApiResponse<RiwayatPelapor>> {
                override fun onResponse(
                    call: Call<ApiResponse<RiwayatPelapor>>,
                    response: Response<ApiResponse<RiwayatPelapor>>
                ) {
                ...
                override fun onFailure(call: Call<ApiResponse<RiwayatPelapor>>, t: Throwable) {
