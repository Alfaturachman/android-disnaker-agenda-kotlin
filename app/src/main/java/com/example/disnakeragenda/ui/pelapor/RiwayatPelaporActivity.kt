...
class RiwayatPelaporActivity : AppCompatActivity() {
    ...
    private fun fetchRiwayatPelaporan(idPelapor: Int) {
        ...
        call.enqueue(object : Callback<ApiResponse<List<RiwayatPelapor>>> {
            override fun onResponse(
                call: Call<ApiResponse<List<RiwayatPelapor>>>,
                response: Response<ApiResponse<List<RiwayatPelapor>>>
            ) {
            ...
            override fun onFailure(call: Call<ApiResponse<List<RiwayatPelapor>>>, t: Throwable) {
