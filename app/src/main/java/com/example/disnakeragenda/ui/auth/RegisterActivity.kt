...
class RegisterActivity : AppCompatActivity() {
    ...
    private lateinit var etPerusahaan: TextInputEditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonRegister.setOnClickListener {
            ...
            val perusahaan = etPerusahaan.text.toString().trim()
            ...
            when {
                ...
                perusahaan.isEmpty() -> {
                    etPerusahaan.error = "Nama Perusahaan tidak boleh kosong"
                }
                telp.isEmpty() -> {
                ...
                alamat.isEmpty() -> {
                    ...
                    registerUser(nama, perusahaan, telp, alamat, email, password)
                }
            }
        }
    }

    private fun registerUser(nama: String, perusahaan: String, telp: String, alamat: String, email: String, password: String) {
        // Buat object JSON
